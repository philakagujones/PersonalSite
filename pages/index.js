    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.message}>
          <p>
            Hello my name is Phil. I am currently finishing up my second year at Simon Fraser University where I am pursuing a degree in computer science. 
